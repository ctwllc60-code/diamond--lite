...
class Amplifier(BaseEngine):
    ...
    def process(self, message_object):
        ...
        previous_layers = len(message_object.enrichment_layers)

        amplification_analysis = {
            "word_count": len(raw.split()),
            "emotional_intensity": "medium",
            "depth_pressure": "increased",
            "previous_enrichment_layers_detected": previous_layers
        }

        message_object.enrichment_layers.append({
            "engine": self.engine_name,
            "type": "cognitive_amplification",
            "content": amplification_analysis
        })
